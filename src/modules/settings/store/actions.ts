...
export const initSettings = (settings: ISettings) =>
  action(SettingsActionTypes.INIT_SETTINGS, settings);
...
export type SettingsAction = IInitSettingsAction | ISetSettingAction;
