...
export const mappingRequestParamsToFormValue = (
  params?: IMappingRequestParams
): IMappingRequestParamFormValue[] => {
...
export const mappingRequestBodyPatternsToFormValue = (
...
export const mappingRequestParamsFormValueToRequestParams = (
  params: IMappingRequestParamFormValue[]
): IMappingRequestParams => {
  return params.reduce(
    (agg: IMappingRequestParams, param: IMappingRequestParamFormValue): IMappingRequestParams => {
      return {
        ...agg,
        [param.key]: {
...
export const mappingRequestBodyPatternsFormValueToBodyPatterns = (
  bodyPatterns: IMappingRequestBodyPatternFormValue[]
): IMappingRequestBodyPattern[] => {
  return bodyPatterns.map(
    (bodyPattern: IMappingRequestBodyPatternFormValue): IMappingRequestBodyPattern => ({
...
export const mappingFormValuesToMapping = (formValues: IMappingFormValues): IMapping => {
  ...
  const mapping: IMapping = {
    ...
    request: {
      ...
      ...url,
      queryParameters: mappingRequestParamsFormValueToRequestParams(formValues.queryParameters),
      headers: mappingRequestParamsFormValueToRequestParams(formValues.requestHeaders),
      cookies: mappingRequestParamsFormValueToRequestParams(formValues.requestCookies),
    ...
    response: {
      ...
      headers: formValues.responseHeaders.reduce(
        (acc, header) => ({
          ...acc,
