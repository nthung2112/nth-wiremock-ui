...
export const loadServerMappings = (server: IServer): ILoadServerMappingsAction =>
  action(MappingsActionTypes.LOAD_SERVER_MAPPINGS, {
...
export const loadServerMappingsRequest = (server: IServer): ILoadServerMappingsRequestAction =>
  action(MappingsActionTypes.LOAD_SERVER_MAPPINGS_REQUEST, {
    serverName: server.name,
    server,
  });
...
export const loadServerMappingsSuccess = (
  ...
  action(MappingsActionTypes.LOAD_SERVER_MAPPINGS_SUCCESS, {
    serverName: server.name,
    server,
    mappings,
  });
...
export const fetchMappingRequest = (
  ...
  action(MappingsActionTypes.FETCH_MAPPING_REQUEST, {
    serverName,
    mappingId,
  });
...
export const fetchMappingSuccess = (
  ...
  action(MappingsActionTypes.FETCH_MAPPING_SUCCESS, {
    serverName,
    mappingId,
    mapping,
  });
...
export const initMappingWorkingCopy = (
  ...
  action(MappingsActionTypes.INIT_MAPPING_WORKING_COPY, {
    serverName,
    mappingId,
  });
...
export const syncMappingWorkingCopy = (
  ...
  action(MappingsActionTypes.SYNC_MAPPING_WORKING_COPY, {
    serverName,
    mappingId,
    update,
  });
...
export const updateMappingRequest = (
  ...
  action(MappingsActionTypes.UPDATE_MAPPING_REQUEST, {
    serverName,
    mappingId,
    mapping,
  });
...
export const deleteMappingRequest = (
  ...
  action(MappingsActionTypes.DELETE_MAPPING_REQUEST, {
    serverName,
    mappingId,
  });
...
export const deleteMappingSuccess = (
  ...
  action(
    ...
    },
    {
      notification: {
        type: "success",
        content: <div>mapping successfully deleted</div>,
        ttl: 2000,
      },
    }
  );
...
export const initCreateMapping = (
  ...
  action(MappingsActionTypes.INIT_CREATE_MAPPING, {
    serverName,
    creationId,
    mapping: {
      id: creationId,
...
export const createMappingRequest = (
  ...
  action(MappingsActionTypes.CREATE_MAPPING_REQUEST, {
    serverName,
    creationId,
    mapping,
  });
...
export const cancelMappingCreation = (
  ...
  action(MappingsActionTypes.CANCEL_CREATE_MAPPING, {
    serverName,
    creationId,
  });
