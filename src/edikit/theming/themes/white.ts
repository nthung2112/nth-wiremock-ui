...
const theme: ITheme = {
  ...
  pane: {
    ...
    css: css`
      ...
      box-shadow: 0 0 0 1px rgba(4, 169, 244, 0), 0 0 0 1px rgba(0, 0, 0, 0.06);
    `,
    current: {
      css: css`
        box-shadow: 0 0 0 5px rgba(4, 169, 244, 0.08), 0 0 0 1px rgba(4, 169, 244, 0.25);
      `,
    },
    header: {
      height: "34px",
  ...
  form: {
    input: {
      ...
      focus: {
        ...
        border: "1px solid #2196f3",
        css: css`
          box-shadow: 0 0 0 3px rgba(4, 169, 244, 0.2);
        `,
      },
      disabled: {},
    },
