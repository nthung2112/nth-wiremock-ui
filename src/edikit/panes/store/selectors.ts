 ...
 */
export const panesNsCurrentPaneSelector = <Data>(panes: Array<IPane<Data>>): IPane<Data> | void =>
  panes.find((pane) => pane.isCurrent);
...
export const panesNsCurrentContentsSelector = <Data>(
  ...
  panes.reduce((agg: Array<IPaneContent<Data>>, pane: IPane<Data>) => {
